 ...
 * [correoCreacionAdministrador]<br>
 * USAGE:
 * <pre>
 *        ClienteCorreoCreacionAdministrador client = new ClienteCorreoCreacionAdministrador();
 ...
 * @author Jose
 */
public class ClienteCorreoCreacionAdministrador {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = ruta.consultarRuta();

    public ClienteCorreoCreacionAdministrador() {
        client = ResteasyClientBuilder.newBuilder().build();
        webTarget = client.target(BASE_URI).path("correoCreacionAdministrador");
    }
     ...
     */
    public <T> T correoCreacionAdministrador(Class<T> responseType, String nombreUsuario, String nombreEmpresa, String usuario, String contrasena, String email) throws ClientErrorException {
