 ...
 * [consultarComitePorUsuario]<br>
 * USAGE:
 * <pre>
 *        ClienteConsultarComitePorUsuario client = new ClienteConsultarComitePorUsuario();
 ...
 * @author Jose
 */
public class ClienteConsultarComitePorUsuario {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = ruta.consultarRuta();

    public ClienteConsultarComitePorUsuario() {
        client = ResteasyClientBuilder.newBuilder().build();
        webTarget = client.target(BASE_URI).path("consultarComitePorUsuario");
    }
     ...
     */
    public <T> T consultarComitePorUsuario(Class<T> responseType, String idUsuario) throws ClientErrorException {
