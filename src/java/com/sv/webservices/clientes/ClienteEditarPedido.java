...
/**
 * Jersey REST client generated for REST resource:application%20(12)
 * [editarPedido]<br>
 * USAGE:
 * <pre>
...
public class ClienteEditarPedido {
    ...
    public ClienteEditarPedido() {
        ...
        webTarget = client.target(BASE_URI).path("editarPedido");
    }
     ...
     */
    public <T> T editarPedido(Class<T> responseType, String idInventario, String idPedido, String ticket) throws ClientErrorException {
        String[] queryParamNames = new String[]{"idInventario", "idPedido", "ticket"};
        String[] queryParamValues = new String[]{idInventario, idPedido, ticket};
        ;
