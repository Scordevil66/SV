...
public class ClienteCorreoVotacion {
     ...
     */
    public <T> T correoVotacion(Class<T> responseType, String nombreUsuario, String usuario, String contrasena, String empresa, String email) throws ClientErrorException {
        String[] queryParamNames = new String[]{"nombreUsuario", "usuario", "contrasena", "empresa", "email"};
        String[] queryParamValues = new String[]{nombreUsuario, usuario, contrasena, empresa, email};
        ;
