...
public class ClienteConsultarUsuarioPorLogin {
     ...
     */
    public <T> T consultarUsuarioPorLogin(Class<T> responseType, String usuario) throws ClientErrorException {
        String[] queryParamNames = new String[]{"usuario"};
        String[] queryParamValues = new String[]{usuario};
        ;
